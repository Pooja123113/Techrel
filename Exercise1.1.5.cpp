...
int main()
    {
     cout<<"check upperlimit and lower limit data type"<<endl;
     cout<<"***************************************"<<endl;
     cout<<"the maximum limit if int data type:  "<<INT_MAX<<endl;
   ...
   cout<<"the bit contain in char data type:  "<<CHAR_BIT<<endl;
   cout<<"the maximum limit of char data type:  "<<CHAR_MAX<<endl;
   cout<<"the minimum limit of char data type:  "<<CHAR_MIN<<endl;
   cout<<"the maxiimum limit of signed char data type:  "<<SCHAR_MAX<<endl;
   cout<<"the minimum limit of singed char data type:  "<<SCHAR_MIN<<endl;
